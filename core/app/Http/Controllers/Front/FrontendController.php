...
class FrontendController extends Controller
{
    ...
    public function index()
    {
        ...
        $data["menus"] = Menu::where("language_id", $currentLang->id)->first()->menus;
    ...
    public function step2(Request $request)
    {
        ...
        return view('front.checkout', [$data, "rtl" => $currentLang->rtl]);
    }
    ...
    public function userDetailView($domain)
    {
        ...
        $data["userBs"] = $userBs;
        $data["packagePermissions"] = json_decode($packagePermissions);
        //$data["packagePermissions"] = $packagePermissions;

        $data["userLangs"] = Language::all();

        $userMenus = UserMenu::select("menus")->where("language_id", $userCurrentLang->id)->first();


        //$userMenusStr = json_encode($userMenus, true);       

        $data["userMenus"] = $userMenus;

        //todo
        $data["userFooterQuickLinks"] = array();
        $data["userContact"] = new stdClass;
        $data["userFooterRecentBlogs"] = array();
    ...
    public function userBlogs(Request $request, $domain)
    {
        ...
        $data["userCurrentLang"] = $userCurrentLang;
        $data["userBs"] = $userCurrentLang->basic_setting;
        //dd($userCurrentLang);
