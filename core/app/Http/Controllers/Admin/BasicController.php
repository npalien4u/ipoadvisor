...
class BasicController extends Controller
{
    ...
    public function script()
    {
        ...
        return view('admin.basic.scripts',  ["data" => $data, "bs" => $bs]);
    }
    ...
    {
        $bs = BasicSetting::select('maintainance_mode', 'maintenance_img', 'maintenance_status', 'maintainance_text', 'secret_path')
            ->first();

        $data["bs"] = $bs;
        return view('admin.basic.maintainance', ["data" => $data, "bs" => $bs, "maintenance_status" => $bs->maintenance_status]);
    }
