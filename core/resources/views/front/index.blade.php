...
<section class="saas-analysis pt-20 pb-20">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-6">
                <div class="choose-img mb-20">
...
<section class="saas-features pb-20">
    <div class="container">
        <div class="row">
            <div class="col-lg-6">
...
<section class="saas-featured-users pt-20 pb-20">
    <div class="container">
        <div class="row">
            <div class="col-lg-6">
                <div class="section-title-one section-title-two mb-20">
        ...
        <div class="user-slide">
            ...
            <div class="user-item">
                ...
                <div class="user-button">
                    <ul>
                        <li><a href="{{detailsUrl($featured_user)}}" class="main-btn"><i class="far fa-link"></i>{{__('Website')}}</a></li>
                        @guest
                        <li>
                ...
                <div class="social-box">
                    <ul class="social-link">
                        ...
                        <li><a href="{{$social->url}}" class="facebook" target="_blank"><i class="{{$social->icon}}"></i></a></li>
                        @endforeach
                    </ul>
                </div>
            </div>
...
<section class="saas-pricing pt-20 pb-20">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-6">
                <div class="section-title-one text-center mb-20">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12">
                        <div class="pricing-item">
                            ...
                            <div class="pricing-button">
                                ...
                                <a href="{{route('front.register.view',['status' => 'trial','id'=> $package->id])}}" class="main-btn">{{__('Trial')}}</a>
                                @endif
                                @if ($package->price == 0)
                                <a href="{{route('front.register.view',['status' => 'regular','id'=> $package->id])}}" class="main-btn">{{__('Signup')}}</a>
                                @else
                                <a href="{{route('front.register.view',['status' => 'regular','id'=> $package->id])}}" class="main-btn">{{__('Purchase')}}</a>
                                @endif
                            </div>
                        </div>
                    </div>
...
<section class="saas-testimonial pb-20">
    <div class="container">
        <div class="row">
            <div class="col-lg-6">
                <div class="section-title-one section-title-two mb-20">
        ...
        <div class="testimonial-slide">
            ...
            <div class="testimonial-item">
                <div class="thumb">
                    <img class="lazy" data-src="{{$testimonial->image ? asset('assets/front/img/testimonials/'. $testimonial->image) : asset('assets/front/img/thumb-1.jpg')}}" alt="">
                </div>
                <div class="content">
...
<!--====== End saas-testimonial section ======-->
@endif

@if ($bs->news_section == 1)
<!--====== Start saas-blog section ======-->
<section class="saas-blog pb-20">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-6">
                <div class="section-title-one text-center m250">
                ...
                <div class="blog-item mb-20">
                    <div class="entry-content">
                        <div class="entry-meta">
                            <ul>
                                <li><span><i class="fas fa-user"></i><a href="{{route('front.blogs', ['category'=>$blog->bcategory->id])}}">{{$blog->bcategory->name}}</a></span></li>
                                <li>
                                    <span>
                    ...
                    <a class="post-img d-block" href="{{route('front.blogdetails',['id' => $blog->id,'slug' => $blog->slug])}}">
                        <img data-src="{{asset('assets/front/img/blogs/'.$blog->main_image)}}" class="img-fluid lazy" alt="">
                    </a>
                </div>
            </div>
            @endforeach
