    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6 col-sm-12">
                <div class="user-item mb-20">
                    <div class="title">
                        @if(isset($user->photo))
                        <img class="lazy" data-src="{{asset('assets/front/img/user/'.$user->photo)}}" alt="">
                        @else
                        <img data-src="{{asset('assets/admin/img/propics/blank_user.jpg')}}" alt="..." class="avatar-img rounded-circle lazy">
                        @endif
                    ...
                    <div class="user-button">
                        <ul>
                            <li><a href="{{detailsUrl($user)}}" class="main-btn"><i class="far fa-link"></i>{{__('Website')}}</a></li>
                            @guest
                            <li>
