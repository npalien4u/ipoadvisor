                    ...
                    <div class="post-details-wrap">
                        ...
                        <div class="post-meta">
                            <ul>
                                ...
                                <li><i class="far fa-calendar-alt"></i><a href="javascript:void(0)">{{\Carbon\Carbon::parse($blog->created_at)->format('F j, Y')}}</a></li>
                            </ul>
                        </div>
                        ...
                        <div class="post-footer d-md-flex align-items-md-center justify-content-md-between">
                            <div class="post-share">
                                <ul>
                                    ...
                                    <li><a href="//www.linkedin.com/shareArticle?mini=true&amp;url={{urlencode(url()->current()) }}&amp;title={{convertUtf8($blog->title)}}"><i class="fab fa-linkedin-in"></i></a></li>
                                </ul>
                            </div>
                        </div>
                        <div class="mt-5">
                                ...
                                @else
                                    @foreach ($latestBlogs as $latestBlog)
                                        <div class="single-post">
                                            <div class="post-thumb">
                                                <img class="lazy" data-src="{{ asset('assets/front/img/user/blogs/' . $latestBlog->image) }}"
                                                    alt="Image">
                                            </div>
                                            <div class="post-desc">
                                                <span class="date"><i class="far fa-calendar-alt"></i>{{\Carbon\Carbon::parse($latestBlog->created_at)->format('F j, Y')}}</span>
                                                <a href="#">
