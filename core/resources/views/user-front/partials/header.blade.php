            ...
            <div class="nav-container">
                ...
                <div class="site-logo">
                    <a href="{{route('front.user.detail.view', getParam())}}">
                        <img class="lazy" data-src="{{asset('assets/front/img/user/'.$userBs->logo)}}" alt="Logo">
                    </a>
                </div>
                @endif
                ...
                <div class="navbar-extra d-flex align-items-center">
                    ...
                    <div class="navbar-btn nav-push-item">
                        <a class="main-btn main-btn-3" href="{{route('front.user.quote', getParam())}}">{{$keywords['Request_A_Quote'] ?? 'Request A Quote'}}</a>
                    </div>
                    @endif
                    @endif
                    <!-- Navbar Toggler -->
