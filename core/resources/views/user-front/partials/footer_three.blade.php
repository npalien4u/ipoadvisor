                        ...
                        <div class="widget site-info-widget">
                            @if(isset($userFooterData->logo))
                                <a class="footer-logo" href="{{route('front.user.detail.view', getParam())}}">
                                    <img class="lazy" data-src="{{asset('assets/front/img/user/footer/'. $userFooterData->logo)}}" alt="logo">
                                </a>
                            @endif
                            <p>{!! isset($userFooterData->about_company) ? replaceBaseUrl($userFooterData->about_company) : "Power of choice is untrammelled & when nothing prevents our being able" !!}</p>
                                ...
                                @foreach($userFooterRecentBlogs as $footerRecentBlog)
                                    <div class="single-post dis-flex mb-4">
                                        <div class="post-thumb">
                                            <img class="lazy" data-src="{{asset('assets/front/img/user/blogs/' . $footerRecentBlog->image)}}"
