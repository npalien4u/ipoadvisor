...
@section('content')
                            ...
                            <div class="row justify-content-center">
                                <div class="col-lg-10">
                                    <div class="banner-content text-center">
                                        <h1 data-animation="fadeInDown"
                                            data-delay="0.8s">{{convertUtf8($slider->title)}}</h1>
                                        <p data-animation="fadeInUp" data-delay="1s">{{convertUtf8($slider->subtitle)}}</p>
                                        <ul class="btn-wrap">
                    ...
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-lg-10">
                                <div class="banner-content text-center">
                                    <h1 data-animation="fadeInDown"
                                        data-delay="0.8s">Take Great Idea To Grow Your Business</h1>
                                    <p data-animation="fadeInUp" data-delay="1s">
                                        Sedut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudanti totam raperiaeaque ipsa quaeab
                                    </p>
                                    <ul class="btn-wrap">
                                        <li data-animation="fadeInLeft" data-delay="1.2s">
                                            <a href="#"
                                            class="main-btn main-btn-4">Our Services</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-6 col-md-10">
                        <div class="about-video">
                            ...
                            @endphp
                            <div class="video-poster-one wow fadeInUp lazy" data-wow-duration="1500ms" data-wow-delay="400ms" data-bg="{{asset('assets/front/img/user/home_settings/'.$aboutBg)}}">
                            </div>
                            <div class="video-poster-two wow fadeInUp lazy" data-wow-duration="1500ms" data-wow-delay="600ms" data-bg="{{asset(isset($home_text->about_video_image) ? asset('assets/front/img/user/home_settings/'.$home_text->about_video_image) : 'assets/front/user/img/video-bg/poster-2.jpg')}}">
                                 @if (!empty($home_text->about_video_url))
                                 <a href="{{$home_text->about_video_url}}"
                    ...
                    @foreach($services as $key => $service)
                        <div class="col-lg-3 col-sm-6 col-10 wow fadeInUp" data-wow-duration="1500ms"
                            ...
                            <div class="service-box-two text-center">
                                ...
                                @endif>
                                    <img class="lazy" data-src="{{isset($service->image) ? asset('assets/front/img/user/services/'.$service->image) : asset('assets/front/img/profile/service-1.jpg')}}"
                                        alt="Icon">
                                </a>
                                <h3>
                                <a 
                    ...
                    @foreach($portfolios as $portfolio)
                        <div class="col-lg-4 col-sm-6">
                            <div class="project-box">
                                <a class="project-thumb d-block" href="{{route('front.user.portfolio.detail', [getParam(), $portfolio->slug, $portfolio->id])}}">
                    ...
                    <div class="col-lg-6 col-md-10 order-lg-2 order-1">
                        ...
                        <div class="process-video bg-img-c lazy" data-bg="{{asset('assets/front/img/work_process/'.$workbg)}}">
                            <div class="video bg-img-c wow fadeInRight lazy" data-wow-duration="1500ms"
                                 data-wow-delay="400ms" data-bg="{{asset('assets/front/img/work_process/'.$workVidBg)}}">
    ...
    @if(isset($home_sections->video_section) && $home_sections->video_section == 1)
        @php
            $videoBg = $home_text->video_section_image ?? 'video_bg.jpg';
        @endphp
        <section class="video-section-two bg-img-c lazy" data-bg="{{asset('assets/front/img/user/home_settings/'. $videoBg)}}">
            <div class="container">
                <div class="row align-content-center justify-content-center">
                    <div class="col-lg-10">
                        <div class="video-cont text-center">
                            @if (!empty($home_text->video_section_url))
                                <a href="{{$home_text->video_section_url}}"
                                class="play-btn popup-video wow fadeInDown" data-wow-duration="1500ms"
                                data-wow-delay="400ms"><i class="fas fa-play"></i></a>
                            @endif
                            <h2>
                                {{$home_text->video_section_title ?? null}}
                            </h2>
                        </div>
                    </div>
                </div>
                            ...
                            @foreach($testimonials as $testimonial)
                                <div class="testimonial-item"
                                    ...
                                    <div class="author-img">
                                        <img class="lazy" data-src="{{ asset('assets/front/img/user/testimonials/'.$testimonial->image)}}"
                                             alt="Image">
                                    </div>
                                    <div class="content">
                                        <p>
                        ...
                        @foreach($blogs as $blog)
                            <div class="latest-post-box-two">
                                <div class="post-thumb-wrap">
                                    <a class="post-thumb bg-img-c d-block" href="{{route('front.user.blog.detail', [getParam(), $blog->slug, $blog->id])}}" style="background-image: url('{{asset('assets/front/img/user/blogs/'.$blog->image)}}')">
                                    </a>
                                    <span class="post-date"><i class="far fa-calendar-alt"></i>{{\Carbon\Carbon::parse($blog->created_at)->toFormattedDateString()}}</span>
                                </div>
                                <div class="post-desc">
                                    <h3 class="title">
