...
@section('content')
            ...
            <div class="container">
                ...
                <div class="row service-boxes justify-content-center">
                    @foreach($services as $service)
                        <div class="col-lg-4 col-md-6 col-sm-8 col-10 col-tiny-12 wow fadeInLeft"
                            ...
                            <div class="service-box text-center">
                                ...
                                <p>{!! strlen(strip_tags($service->content)) > 80 ? mb_substr(strip_tags($service->content), 0, 80, 'UTF-8') . '...' : strip_tags($service->content) !!}</p>
                                @if($service->detail_page == 1)
    ...
    @if(isset($home_sections->video_section) && $home_sections->video_section == 1)
        @php
            $videoBg = $home_text->video_section_image ?? 'video_bg_one.jpg';
        @endphp
        <section class="video-section bg-img-c section-gap lazy" data-bg="{{asset('assets/front/img/user/home_settings/'. $videoBg)}}">
            <div class="container">
                <div class="row align-items-center justify-content-between">
                    <div class="col-xl-7 col-lg-8 col-md-10 order-2 order-md-1">
                        <div class="video-text">
                            <div class="section-title left-border mb-30">
                                @if (!empty($home_text->video_section_title))
                                <span class="title-tag">{{$home_text->video_section_title}}</span>
                                @endif
                                <h2 class="title">
                                    {{$home_text->video_section_subtitle ?? null}}
                                </h2>
                            </div>
                            @if (!empty($home_text->video_section_text))
                            <p>
                                {!! nl2br($home_text->video_section_text) !!}
                            </p>
                            @endif
                            @if (!empty($home_text->video_section_button_url))
                            <a href="{{$home_text->video_section_button_url}}"
                               class="main-btn">{{$home_text->video_section_button_text}}</a>
                            @endif
                        </div>
                    </div>
                    ...
                    @foreach($portfolios as $portfolio)
                        <div class="col-lg-4 col-md-6 col-10 col-tiny-12">
                            <div class="feature-box">
                                <a href="{{route('front.user.portfolio.detail', [getParam(), $portfolio->slug, $portfolio->id])}}" class="feature-bg bg-img-c lazy" data-bg="{{asset('assets/front/img/user/portfolios/'.$portfolio->image)}}">
                                </a>
                                <div class="feature-desc">
                                    <a href="{{route('front.user.portfolio.detail', [getParam(), $portfolio->slug, $portfolio->id])}}" class="feature-link"><i class="fal fa-long-arrow-right"></i></a>
                                    <a href="{{route('front.user.portfolio.detail', [getParam(), $portfolio->slug, $portfolio->id])}}" class="feature-link d-block mb-0">
                    ...
                    <div class="row align-items-center justify-content-center">
                        <div class="col-lg-6">
                            <div class="wcu-image text-center text-lg-left wow fadeInUp" data-wow-duration="1500ms"
                                 data-wow-delay="400ms">
                                <img data-src="{{asset('assets/front/img/user/home_settings/'. $whyChooseImg)}}" alt="Image" class="lazy">
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-10">
                            <div class="wcu-text">
                                ...
                                <a href="{{$home_text->why_choose_us_section_button_url}}"  class="main-btn main-btn-4" target="_blank">{{$home_text->why_choose_us_section_button_text}}</a>
                                @endif
                            </div>
                        </div>
                    </div>
                    <img data-src="{{asset('assets/front/user/img/lines/03.png')}}" alt="shape" class="line-shape-one lazy">
                    <img data-src="{{asset('assets/front/user/img/lines/04.png')}}" alt="shape" class="line-shape-two lazy">
                </div>
            </div>
        </section>
    @endif
                    ...
                    <div class="col-lg-6 col-md-10">
                        <div class="piechart-boxes">
                            @foreach($skills as $skill)
                                <div class="chart-box">
                                    <div class="chart" data-percent="{{$skill->percentage}}" data-bar-color="#{{$skill->color}}">
    ...
    @if(isset($home_sections->testimonials_section) && $home_sections->testimonials_section == 1)
        <section class="testimonial-section grey-bg">
                        ...
                        <div class="testimonial-items" id="testimonialSliderOne">
                            @foreach($testimonials as $testimonial)
                                <div class="testimonial-item">
                                    ...
                                    <div class="author">
                                        <div class="thumb">
                                            <img class="lazy" data-src="{{asset('assets/front/img/user/testimonials/'.$testimonial->image)}}" alt="img">
                                        </div>
                                        <div class="desc">
            ...
            <div class="testimonial-img">
                <img class="lazy" data-src="{{asset('assets/front/img/user/home_settings/'. $tstmImg)}}" alt="testimonial">
            </div>
        </section>
    @endif
                ...
                <div class="row align-items-center justify-content-center">
                    ...
                    <div class="col-lg-6 col-md-4 col-10 col-tiny-12">
                        <div class="text-md-right mt-30 mt-md-0">
                            <a href="{{route('front.user.blogs',getParam())}}" class="main-btn">{{$home_text->view_all_blog_text ?? 'View All'}}</a>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-lg-4 col-md-6 col-10 col-tiny-12 wow fadeInLeft" data-wow-duration="1500ms"
                            ...
                            <div class="latest-post-box">
                                <div class="post-thumb-wrap">
                                    <a class="post-thumb bg-img-c lazy" href="{{route('front.user.blog.detail', [getParam(), $blog->slug, $blog->id])}}" data-bg="{{asset('assets/front/img/user/blogs/'.$blog->image)}}">
                                    </a>
                                </div>
                                <div class="post-desc">
                                    <span class="post-date"><i class="far fa-calendar-alt"></i>{{\Carbon\Carbon::parse($blog->created_at)->format('F j, Y')}}</span>
                                    <h3 class="title">
