                ...
                <div class="row align-items-center">
                    <div class="col-md-5">
                        <div class="banner-content">
                            <span class="promo-text wow fadeInLeft" data-wow-duration="1500ms" data-wow-delay="400ms">{{$static->title ?? "Business & Consulting"}}</span>
                            ...
                            <ul class="btn-wrap">
                                <li class="wow fadeInUp" data-wow-duration="1500ms" data-wow-delay="600ms">
                                    <a href="{{$static->btn_url}}" target="_blank" class="main-btn">{{$static->btn_name ?? "Our Services"}}</a>
                                </li>
                            </ul>
                            @endif
                        </div>
                    ...
                    <div class="col-md-7 d-none d-md-block">
                        <div class="banner-img text-right wow fadeInRight" data-wow-duration="1500ms" data-wow-delay="800ms">
                            @if(isset($static->img))
                            <img class="lazy" data-src="{{asset('assets/front/img/hero_static/'. $static->img)}}" alt="Hero Image">
                            @else
                            <img class="lazy" data-src="{{asset('assets/front/img/hero_static/hero_3.png')}}" alt="Hero Image">
                            @endif
                        </div>
                    </div>
                </div>
        ...
        <div class="row service-boxes justify-content-center">
            ...
            <div class="col-lg-3 col-sm-6 col-10 wow fadeInLeft" data-wow-duration="1500ms" data-wow-delay="400ms">
                <div class="service-box-three">
                    <a class="icon" @if($service->detail_page == 1)
                    ...
                    <h3>
                        <a @if($service->detail_page == 1)
                            href="{{route('front.user.service.detail',[getParam(),'slug' => $service->slug,'id' => $service->id])}}"
                            @endif
                            >{{$service->name}}</a>
                    </h3>
                    @if($service->detail_page == 1)
                    <a href="{{route('front.user.service.detail',[getParam(),'slug' => $service->slug,'id' => $service->id])}}" class="service-link mt-0">
        ...
        <div class="row justify-content-center align-items-center">
            <div class="col-lg-6 col-md-10 order-2 order-lg-1">
                <div class="about-text-three">
                    <div class="section-title left-border mb-40">
                        ...
                        @endisset
                        <h2 class="title">{{!empty($home_text->about_subtitle) ? $home_text->about_subtitle : null}}</h2>
                    </div>
                    ...
                    <a href="{{$home_text->about_button_url}}" class="main-btn main-btn-4">{{$home_text->about_button_text}}</a>
                    @endif
            ...
            <div class="col-lg-6 col-md-10 order-1 order-lg-2">
                <div class="about-tile-gallery">
                    ...
                    @endphp
                    <img data-src="{{asset('assets/front/img/user/home_settings/'.$aboutImg)}}" alt="Image" class="image-one wow fadeInRight lazy" data-wow-duration="1500ms" data-wow-delay="400ms">
                </div>
            </div>
        </div>
    </div>
...
@if(in_array('Portfolio',$packagePermissions) && isset($home_sections->portfolio_section) && $home_sections->portfolio_section == 1)
<section class="project-section-two section-gap">
    <div class="container">
        ...
        <div class="row project-boxes mt-80 masonary-layout align-items-center">
            ...
            <div class="col-lg-4 col-sm-6 order-2 order-lg-1">
                <div class="project-box wow fadeInLeft" data-wow-duration="1500ms" data-wow-delay="400ms">
                    <a class="project-thumb" href="{{route('front.user.portfolio.detail', [getParam(), $portfolio->slug, $portfolio->id])}}">
                        <div class="thumb bg-img-c lazy" data-bg="{{asset('assets/front/img/user/portfolios/'.$portfolio->image)}}"></div>
                    </a>
                    <div class="project-desc text-center">
                        ...
                        <a href="{{route('front.user.portfolio.detail', [getParam(), $portfolio->slug, $portfolio->id])}}" class="project-link">
                            <i class="fal fa-long-arrow-right"></i>
                        </a>
                    </div>
                </div>
        ...
        <div class="view-more-btn text-center mt-50">
            <a href="{{route('front.user.portfolios',getParam())}}" class="main-btn main-btn-3">{{$home_text->view_all_portfolio_text ?? 'View All'}}</a>
        </div>
    </div>
</section>
@endif
...
<section class="faq-section section-gap with-illustration with-shape grey-bg">
    <div class="container">
        ...
        <div class="row justify-content-lg-end justify-content-center">
            <div class="col-lg-6">
                <img class="lazy" data-src="{{asset('assets/front/img/user/home_settings/'.$faqBg)}}" alt="illustration">
            </div>
            <div class="col-lg-6">
                <div class="faq-content">
                    <div class="section-title mb-40 left-border">
                        ...
                        @endisset
                        <h2 class="title">{{ !empty($home_text->faq_section_subtitle) ? $home_text->faq_section_subtitle : null }}</h2>
                    </div>
                    <!-- FAQ LOOP -->
                    <div class="accordion faq-loop" id="faqAccordion">
                        @foreach ($faqs as $key=> $faq)
                        <div class="card">
                            <div @if($key==0) class="card-header active-header" @else class="card-header" @endif>
                                <h6 class="collapsed" data-toggle="collapse" data-target="#collapse{{$faq->id}}">
                                    {{ $faq->question }}
                                    <span class="icons">
                                        @if($key==0) <i class="far fa-minus"></i> @else <i class="far fa-plus"></i> @endif
                                    </span>
                                </h6>
                            </div>

                            <div id="collapse{{$faq->id}}" data-parent="#faqAccordion" @if($key==0) class="collapse show" @else class="collapse" @endif>
                                <div class="card-body">
                                    {{ $faq->answer }}
                                </div>
                            </div>
...
@if((isset($home_sections->counter_info_section) && $home_sections->counter_info_section == 1) || (isset($home_sections->work_process_section) && $home_sections->work_process_section == 1))
<!--====== Fact Section Start ======-->
<section class="fact-section-three section-gap working-process-section">
    <div class="container">
        <div class="row align-items-center justify-content-center">
            ...
            <div class="{{$home_sections->counter_info_section == 1 ? 'col-lg-6' : 'col-12'}} order-lg-1 order-2">
            ...
            <div class="col">
                <div class="team-member">
                    ...
                    <div class="member-desc">
                        <h3 class="name"><a href="javascript:void(0)">{{convertUtf8($team->name)}}</a></h3>
        ...
        <div class="row align-items-center justify-content-center">
            <div class="col-lg-6 col-md-10">
                <div class="wcu-video wow fadeInLeft" data-wow-duration="1500ms" data-wow-delay="400ms">
                    ...
                    @endphp
                    <div class="video-poster-one bg-img-c" style="background-image: url({{asset('assets/front/img/user/home_settings/'. $whyBg)}});">
                    </div>
                    @php
                    $vidBg = $home_text->why_choose_us_section_video_image ?? 'why_choose_us_video_bg.jpg';
                    @endphp
                    <div class="video-poster-two bg-img-c lazy" data-bg="{{asset('assets/front/img/user/home_settings/'. $vidBg)}}">
            ...
            <div class="col-lg-6 col-md-10">
                <div class="wcu-text-two">
                    ...
                    <a href="{{$home_text->why_choose_us_section_button_url}}" class="main-btn" target="_blank">{{$home_text->why_choose_us_section_button_text}}</a>
                    @endisset
                </div>
            </div>
        </div>
...
<section class="cta-aection section-gap-bottom">
    <div class="container">
        <div class="cta-wrap bg-img-c lazy" data-bg="{{asset('assets/front/img/user/home_settings/quote_bg.png')}}">
                ...
                <div class="col-lg-8">
                    <div class="cta-content text-center">
                        <div class="section-title both-border mb-30">
                            ...
                            @endisset
                            <h2 class="title">{{!empty($home_text->quote_section_subtitle) ? $home_text->quote_section_subtitle : null}}</h2>
                        </div>
                        <a href="{{route('front.user.quote', getParam())}}" class="main-btn main-btn-3">{{$keywords['Request_A_Quote'] ?? 'Request A Quote'}}</a>
                    </div>
                </div>
            </div>
        </div>
...
@endphp
<section class="testimonial-section-three bg-img-c lazy" data-bg="{{asset('assets/front/img/user/home_settings/'. $tstmBg)}}">
    <div class="container">
                ...
                <div class="testimonial-items" id="testimonialSliderThree">
                    ...
                    <div class="testimonial-item text-center">
                        <div class="author-thumb">
                            <img src="{{asset('assets/front/img/user/testimonials/'.$testimonial->image)}}" alt="image">
                        </div>
            ...
            <div class="row no-gutters">
                <div class="col-lg-6">
                    <div class="contact-map">
                        <iframe class="border-0" src="//www.google.com/maps?width=100%25&amp;height=600&amp;hl=en&amp;q={{$contact->latitude ?? '36.7783'}},%20{{$contact->longitude ?? '119.4179'}}+(My%20Business%20Name)&amp;t=&amp;z=10&amp;ie=UTF8&amp;iwloc=B&amp;output=embed" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
                    </div>
                </div>
                <div class="col-lg-6">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="input-group mb-30">
                                        <input type="text" placeholder="{{$keywords["Name"] ?? "Name"}}" name="fullname" value="{{old('fullname')}}" required>
                                ...
                                <div class="col-12">
                                    <div class="input-group mb-30">
                                        <input type="email" placeholder="{{$keywords["Email_Address"] ?? "Email Address"}}" name="email" value="{{old('email')}}" required>
                                ...
                                <div class="col-12">
                                    <div class="input-group select mb-30">
                                        <input type="text" placeholder="{{$keywords["Subject"] ?? "Subject"}}" name="subject" value="{{old('subject')}}" required>
            ...
            <div class="row align-items-center justify-content-between" id="clientSlider">
                ...
                <div class="col">
                    <a href="{{$brand->brand_url}}" class="client-img d-block text-center" target="_blank">
                        <img class="lazy" data-src="{{asset('assets/front/img/user/brands/'.$brand->brand_img)}}" alt="">
                    </a>
                </div>
                @endforeach
            </div>
