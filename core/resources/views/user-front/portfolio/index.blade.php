                    ...
                    <div class="isotope-item col-lg-4 col-sm-6 item-{{$portfolio->bcategory->id}}">
                        <div class="project-box hover-style">
                            ...
                            <div class="project-desc text-center">
                                <h4><a href="{{route('front.user.portfolio.detail', [getParam(), $portfolio->slug, $portfolio->id])}}">{{strlen($portfolio->title) > 30 ? mb_substr($portfolio->title, 0, 30, 'UTF-8') . '...' : $portfolio->title}}</a></h4>
