              ...
              <form id="permissionsForm" class="" action="{{route('admin.package.features')}}" method="post">
                ...
                <div class="form-group">
                    ...
                    <div class="selectgroup selectgroup-pills">
                        ...
                        <label class="selectgroup-item">
                            <input type="checkbox" name="features[]" value="Request a Quote" class="selectgroup-input" @if(is_array($features) && in_array('Request a Quote', $features)) checked @endif>
                        ...
                        <label class="selectgroup-item">
                            <input type="checkbox" name="features[]" value="Counter Information" class="selectgroup-input" @if(is_array($features) && in_array('Counter Information', $features)) checked @endif>
                        ...
                        <label class="selectgroup-item">
                            <input type="checkbox" name="features[]" value="Career" class="selectgroup-input" @if(is_array($features) && in_array('Career', $features)) checked @endif>
                            <span class="selectgroup-button">{{__('Career')}}</span>
                        </label>
                        <label class="selectgroup-item">
                            <input type="checkbox" name="features[]" value="Team" class="selectgroup-input" @if(is_array($features) && in_array('Team', $features)) checked @endif>
