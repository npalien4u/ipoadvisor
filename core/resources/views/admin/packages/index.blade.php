                    ...
                    <form id="ajaxForm" enctype="multipart/form-data" class="modal-form"
                        ...
                        <div class="form-group">
                            ...
                            <div class="selectgroup selectgroup-pills">
                                ...
                                <label class="selectgroup-item">
                                    <input type="checkbox" name="features[]" value="Request a Quote" class="selectgroup-input">
                                ...
                                <label class="selectgroup-item">
                                    <input type="checkbox" name="features[]" value="Counter Information" class="selectgroup-input">
