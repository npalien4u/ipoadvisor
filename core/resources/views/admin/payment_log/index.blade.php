                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <p>{{!empty($membership->user) ? $membership->user->username : '-'}}</p>
                                                    <label>{{__('Company')}}</label>
                                                    <p>{{!empty($membership->user) ? $membership->user->company_name : '-'}}</p>
                                                    ...
                                                    <p><strong>{{__('Cost')}}: </strong> {{$membership->price == 0 ? "Free" : $membership->price}}
                                                    </p>
