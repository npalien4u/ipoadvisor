                        ...
                        <div class="col-lg-4 offset-lg-1 mt-2 mt-lg-0">
                            @if(!is_null($userDefaultLang))
                                <a href="#" class="btn btn-primary float-right btn-sm" data-toggle="modal"
                                   data-target="#createModal"><i class="fas fa-plus"></i> {{__('Add Portfolio Category')}}</a>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @if ($category->status == 1)
                                                            <h2 class="d-inline-block"><span
                                                                    class="badge badge-success">{{__('Active')}}</span></h2>
                                                        @else
                                                    ...
                                                    <td>
                                                        <a class="btn btn-secondary btn-sm editbtn" href="#editModal"
                                                           data-toggle="modal" data-bcategory_id="{{$category->id}}"
                                                        ...
                                                        <form class="deleteform d-inline-block"
                                                              ...
                                                              method="post">
                                                            @csrf
                                                            <input type="hidden" name="bcategory_id" value="{{$category->id}}">
                ...
                <div class="modal-body">
                    <form id="ajaxForm" class="modal-form create" action="{{route('user.portfolio.category.store')}}"
                        ...
                        <div class="form-group">
                            ...
                            <p class="text-warning"><small>{{__('The higher the serial number is, the later the portfolio category will be shown.')}}</small></p>
                        </div>
                    </form>
                </div>
    ...
    <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="ajaxEditForm" class="" action="{{route('user.portfolio.category.update')}}" method="POST">
                        @csrf
