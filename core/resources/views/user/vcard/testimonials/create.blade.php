          ...
          <div class="modal-body">
             ...
             <form id="ajaxForm" enctype="multipart/form-data" class="modal-form" action="{{route('user.vcard.testimonialStore')}}" method="POST">
                ...
                <div class="form-group">
                   ...
                   <input type="text" class="form-control {{$vcard->direction == 2 ? 'rtl' : ''}}" name="name" value="">
                   <p id="errname" class="mb-0 text-danger em"></p>
                </div>
                <div class="form-group">
                   <label for="">{{__('Rating')}} **</label>
                   <input type="number" class="form-control ltr" name="rating" value="" min="1" max="5">
               ...
               <div class="form-group">
                  ...
                  <textarea class="form-control {{$vcard->direction == 2 ? 'rtl' : ''}}" name="comment" rows="4" cols="80" ></textarea>
