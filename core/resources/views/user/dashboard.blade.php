...
@section('content')
    ...
    @if (is_null($package))
        <div class="alert alert-warning">
            {{__('Your membership is expired. Please')}} <a href="{{route('user.plan.extend.index')}}">{{__('click here')}}</a> {{__('to purchase a new package / extend the current package.')}}
        </div>
    @else
    ...
    <div class="row">
        ...
        <div class="col-sm-6 col-md-4">
            <a class="card card-stats card-secondary card-round" href="{{route('user.counter-information.index')}}">
                <div class="card-body">
                    <div class="row">
                        <div class="col-5">
                            <div class="icon-big text-center">
                        ...
                        <div class="col-7 col-stats">
                            <div class="numbers">
                                <p class="card-category">{{__('Counter Information')}}</p>
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <p><strong
                                                                    >{{__('Title')}}: </strong>{{$membership->package->title}}
                                                                </p>
                                                                <p><strong
                                                                    >{{__('Term')}}: </strong> {{$membership->package->term}}
                                                                </p>
