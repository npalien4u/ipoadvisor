                            ...
                            >
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12 showImage mb-3">
                                        <img
                                            src="{{isset($data->work_process_section_img) ? asset('assets/front/img/work_process/'. $data->work_process_section_img) : asset('assets/admin/img/noimage.jpg')}}"
                                            alt="..." class="img-thumbnail">
                                    </div>
                                    <input type="file" name="work_process_section_img" id="image"
                                           class="form-control image">
                                    @if ($errors->has('work_process_section_img'))
                                        <p class="mt-2 mb-0 text-danger">{{ $errors->first('work_process_section_img') }}</p>
                                    @endif
                                </div>
                                @endif
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            ...
                                            <input type="text" class="form-control" name="work_process_section_title"
                                                   value="{{ $data->work_process_section_title ?? '' }}" placeholder="Enter title">
                                            @if ($errors->has('work_process_section_title'))
                                                <p class="mt-2 mb-0 text-danger">{{ $errors->first('work_process_section_title') }}</p>
                                            @endif
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            ...
                                            <input type="text" class="form-control" name="work_process_section_subtitle"
                                                   value="{{$data->work_process_section_subtitle ?? '' }}" placeholder="Enter subtitle">
                                            @if ($errors->has('work_process_section_subtitle'))
                                                <p class="mt-2 mb-0 text-danger">{{ $errors->first('work_process_section_subtitle') }}</p>
                                            @endif
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="work_process_section_text" rows="5"
                                              cols="80" placeholder="Enter content">{{ $data->work_process_section_text ?? null}}</textarea>
                                    @if ($errors->has('work_process_section_text'))
                                        <p class="mt-2 mb-0 text-danger">{{ $errors->first('work_process_section_text') }}</p>
                                    @endif
                                </div>
                                @if($userBs->theme === 'home_two')
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12 showTestimonialImage mb-3">
                                            <img
                                                src="{{isset($data->work_process_section_video_img) ? asset('assets/front/img/work_process/'. $data->work_process_section_video_img) : asset('assets/admin/img/noimage.jpg')}}"
                                                alt="..." class="img-thumbnail">
                                        </div>
                                        <input type="file" name="work_process_section_video_img" id="testimonial_image"
                                               class="form-control image">
                                        @if ($errors->has('work_process_section_video_img'))
                                            <p class="mt-2 mb-0 text-danger">{{ $errors->first('work_process_section_video_img') }}</p>
                                        @endif
                                    </div>
                                    <div class="form-group">
                                        <label for="">{{ __('Video URL') }}</label>
                                        <input type="text" class="form-control ltr" name="work_process_section_video_url"
                                               value="{{$data->work_process_section_video_url ?? '' }}" placeholder="Enter video url">
                                        @if ($errors->has('work_process_section_video_url'))
                                            <p class="mt-2 mb-0 text-danger">{{ $errors->first('work_process_section_video_url') }}</p>
                                        @endif
                                    </div>
                                @endif
                            </form>
        ...
        <div class="col-lg-7">
            <div class="card">
                <div class="card-header">
                    ...
                    <a href="{{ route('user.home_page.work_process_section.create_work_process') }}" class="btn btn-primary btn-sm float-right"
                    ><i class="fas fa-plus"></i> {{ __('Add Work Process') }}</a>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-12">
